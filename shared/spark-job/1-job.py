...
# Delete hudi_celebrities table and files
spark.sql("DROP TABLE IF EXISTS hudi_celebrities")
os.system("hdfs dfs -rm -r /wiki/hudi_celebrities")

os.system("echo 'PROCESSING DATA... THIS OPERATION CAN TAKE SEVERAL MINUTES'")
...
df.write.format("org.apache.hudi").options(
    **hudi_options).mode("overwrite").save(basePath)
